...
print(f"List로 중복 제거: {unique_visitors_list}")
...
'''
Unhashable(해시 불가능한) 타입은 저장 불가 - 가변 타입들(리스트, 딕셔너리, set)
...
'''
frozenset은 불변 -> 수정 메서드들이 모두 에러 발생
