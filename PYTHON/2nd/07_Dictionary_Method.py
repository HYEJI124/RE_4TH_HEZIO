...
'''
주의사항:
1. 순회 중 딕셔너리 크기 변경 금지
    - 순회 중 키 추가/삭제하면 RuntimeError 발생 가능
...
'''
# 메모리 사용량 비교 (개념적 설명)
- dict.keys(): 뷰 객체 - 메모리 효율적
- list(dict.keys()): 실제 리스트 - 메모리 사용량 증가
- 일반적으로 list() 변환은 필요할 때만 사용
'''