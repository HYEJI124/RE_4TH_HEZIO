# 1. NumPy(Numerical Python)란 무엇인가?
"""
Numpy는 파이썬에서 과학 계산을 위한 핵심 라이브러리
...
- NumPy 배열: 연속된 메모리 공간에 같은 다입의 데이터를 저장
...
print('=== 명시적 타입 지정 ===')
"""
dtype 매개변수로 원하는 데이터 타입을 명시적으로 지정 가능
...
"""
5. 새로운 난수 생성 방식 (권장)- default_rng (Random Generator)
