...
print(f"의미: (행 개수, 열 개수) = ({test_data.shape[0]}행, {test_data.shape[1]}열)")
...
print(f"계산: {test_data.shape[0]} × {test_data.shape[1]} = {test_data.size}")
...
# 7. DataFrame 정보 확인 메소드

print("[5] DataFrame 정보 확인 메소드")

# 7-1. head() - 처음 n개 행
print("[5-1] head() - 처음 5개 행 (기본값)")
print(df.head())
print()
