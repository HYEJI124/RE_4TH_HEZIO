...
'''
데이터를 특정 기준으로 묶어서 분석하는 기법
SQL의 GROUP BY와 유사하며, 데이터 분석의 필수 도구
'''
...
# 1. GroupBy의 핵심 개념: Split-Apply-Combine
...
# describe(): 여러 통계를 한 번에 계산하는 편리한 메소드
...
# 8. 다중 그룹화 (Multiple Grouping) - 여러 컬럼을 기준으로 계층적 그룹화
