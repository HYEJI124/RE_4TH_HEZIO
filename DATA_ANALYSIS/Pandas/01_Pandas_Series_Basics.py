...
# 예제 1: 금요일을 제외한 평일 중 매출 200 이상
print("[10-1] 금요일을 제외한 평일 중 매출 200 이상")
...
# 방법 1: fill_value 사용
print("[13-1] fill_value로 없는 값을 0으로 채워서 연산")
